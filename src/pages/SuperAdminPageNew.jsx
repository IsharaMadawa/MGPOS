      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 mb-6">
          <div className="flex border-b border-gray-200">
            ...
            <button
              onClick={() => setActiveTab('single-org-users')}
              className={`px-4 py-3 text-sm font-medium border-b-2 transition-colors ${
                activeTab === 'single-org-users'
                  ? 'border-emerald-500 text-emerald-600'
                  : 'border-transparent text-gray-500 hover:text-gray-700'
              }`}
            >
            ...
            <button
              onClick={() => setActiveTab('multi-org-users')}
              className={`px-4 py-3 text-sm font-medium border-b-2 transition-colors ${
                activeTab === 'multi-org-users'
                  ? 'border-emerald-500 text-emerald-600'
                  : 'border-transparent text-gray-500 hover:text-gray-700'
              }`}
            >
          ...
          {/* Single-Org Users Tab Content */}
          {activeTab === 'single-org-users' && (
            <div className="p-4">
              <div className="bg-white rounded-xl shadow-sm border border-gray-200">
                <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                  <h2 className="font-semibold text-gray-900">Create Single-Organization User</h2>
                  <button
                ...
                {/* Users List */}
                <div className="p-4">
                  <h3 className="font-medium text-gray-900 mb-4">Users by Organization</h3>
                  {organizations.map(org => (
                    <div key={org.id} className="mb-6">
                      <div className="bg-gray-50 rounded-lg p-3 mb-3">
                        <h4 className="font-medium text-gray-900">{org.name} ({org.id})</h4>
                      </div>
